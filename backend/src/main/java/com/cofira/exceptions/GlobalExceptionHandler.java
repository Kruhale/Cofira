...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleGlobalException(Exception ex) {
        // El detalle real se registra en el log del servidor, nunca en la respuesta:
        // exponer el mensaje interno al cliente es una fuga de información.
