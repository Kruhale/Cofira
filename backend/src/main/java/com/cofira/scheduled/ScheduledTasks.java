...
public class ScheduledTasks {
    ...
    private GenerarRutinaRequestDTO construirSolicitudDesdePerfilYFeedback(Usuario usuario, UserProfile perfil) {
        ...
        FeedbackEjercicio ultimoFeedback = obtenerUltimoFeedback(usuario);
        ...
        GenerarRutinaRequestDTO.GenerarRutinaRequestDTOBuilder solicitudBuilder = GenerarRutinaRequestDTO.builder()
                ...
                .deportesDisponibles(perfil.getSports())
        ...
        if (ultimoFeedback != null) {
            ...
            solicitudBuilder.comentariosSemana(ultimoFeedback.getComentarios());
            solicitudBuilder.nivelFatigaMedio(ultimoFeedback.getNivelFatiga());
        }
    ...
    private FeedbackEjercicio obtenerUltimoFeedback(Usuario usuario) {
        return feedbackEjercicioRepository.findTopByUsuarioIdOrderBySemanaNumeroDesc(usuario.getId()).orElse(null);
    }
    ...
    private String mapearObjetivoPrincipal(com.cofira.enums.PrimaryGoal objetivo) {
        if (objetivo == null) {
    ...
    private String mapearGenero(com.cofira.enums.Gender genero) {
        if (genero == null) {
            return "Masculino";
        }
    ...
    private DiaEjercicio convertirDiaEjercicioDTO(com.cofira.dto.ollama.DiaEjercicioGeneradoDTO diaDTO) {
    ...
    private Ejercicios convertirEjercicioDTO(com.cofira.dto.ollama.EjercicioGeneradoDTO ejercicioDTO) {
