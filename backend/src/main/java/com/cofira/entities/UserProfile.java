...
import com.cofira.enums.ActivityLevel;
import com.cofira.enums.Gender;
import com.cofira.enums.PrimaryGoal;
import com.cofira.enums.WorkType;
...
public class UserProfile {
    ...
    // Deportes que el usuario puede practicar (correr, ciclismo, natacion...)
    @ElementCollection
    @CollectionTable(name = "user_profile_sports", joinColumns = @JoinColumn(name = "user_profile_id"))
    @Column(name = "sport")
