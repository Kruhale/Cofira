...
export class AlimentacionService {
  ...
  // Menú de EJEMPLO para cuentas gratis: solo señales, sin tocar localStorage,
  // para que al pasar a PRO el menú real cargue limpio desde el servidor
  cargarMenuDemo(menu: MenuGuardado): void {
    this.fechaInicio.set(menu.fechaInicio);
    this.fechaFin.set(menu.fechaFin);
    this.comidasPorFecha.set(menu.comidasPorFecha);
