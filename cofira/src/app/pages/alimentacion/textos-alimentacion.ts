...
interface TextosAlimentacion {
  ...
  diasSemana: string[];
  diasSemanaCorto: string[];
  etiquetaHoy: string;
  metaPlanActivo: string;
  metaSinPlan: string;
  ariaSeleccionarDia: string;
  ariaMarcarConsumida: string;
  saludoManana: string;
  saludoTarde: string;
  saludoNoche: string;
}
...
export const TEXTOS_ALIMENTACION: Record<CodigoIdioma, TextosAlimentacion> = {
  es: {
    ...
    etiquetaHoy: 'Hoy',
    metaPlanActivo: 'Plan activo',
    metaSinPlan: 'Sin plan activo',
    ariaSeleccionarDia: 'Ver el menú del',
    ariaMarcarConsumida: 'Marcar como consumida:',
  ...
  en: {
    ...
    diasSemanaCorto: ['S', 'M', 'T', 'W', 'T', 'F', 'S'],
    etiquetaHoy: 'Today',
    metaPlanActivo: 'Active plan',
    metaSinPlan: 'No active plan',
    ariaSeleccionarDia: 'View menu for',
    ariaMarcarConsumida: 'Mark as eaten:',
