...
interface TextosPerfil {
  ...
  avisoPerfilError: string;
  tituloEntrenamiento: string;
  notaEntrenamiento: string;
  tituloDeportes: string;
  tituloEquipamiento: string;
  botonGuardarEntrenamiento: string;
  avisoEntrenamientoGuardado: string;
  avisoEntrenamientoError: string;
}
...
export const TEXTOS_PERFIL: Record<CodigoIdioma, TextosPerfil> = {
  es: {
    ...
    avisoPerfilError: 'No se pudo guardar el perfil. Inténtalo de nuevo.',
    tituloEntrenamiento: 'Mi entrenamiento',
    notaEntrenamiento:
      'Activa o desactiva deportes y equipamiento según tu temporada: la próxima rutina se adaptará a lo que marques aquí.',
    tituloDeportes: 'Deportes disponibles',
    tituloEquipamiento: 'Equipamiento',
    botonGuardarEntrenamiento: 'Guardar cambios',
    avisoEntrenamientoGuardado: 'Guardado: tu próxima rutina usará esta configuración',
    avisoEntrenamientoError: 'No se pudo guardar la configuración. Inténtalo de nuevo.',
  },
  en: {
    eyebrow: 'My account',
    ...
    avisoPerfilError: 'Could not save your profile. Please try again.',
    tituloEntrenamiento: 'My training',
    notaEntrenamiento:
      'Enable or disable sports and equipment based on your season: your next routine will adapt to what you set here.',
    tituloDeportes: 'Available sports',
    tituloEquipamiento: 'Equipment',
    botonGuardarEntrenamiento: 'Save changes',
    avisoEntrenamientoGuardado: 'Saved: your next routine will use this setup',
    avisoEntrenamientoError: 'Could not save your setup. Please try again.',
  },
};
