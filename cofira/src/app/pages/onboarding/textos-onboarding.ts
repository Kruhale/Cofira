...
export const TEXTOS_ONBOARDING: Record<CodigoIdioma, TextosOnboarding> = {
  es: {
    ...
    asideEscenas: [
      {
        eyebrow: 'Cofira · Sistema',
        titulo: 'Estás a un paso de',
        tituloAcento: 'tu sistema.',
        texto: 'Entrenamiento, nutrición y progreso — hechos a tu medida.',
      },
      {
        eyebrow: 'Cofira · Tu cuerpo',
        titulo: 'Tu punto de partida',
        tituloAcento: 'lo marcas tú.',
        texto: 'Peso, altura y objetivo: la base para calcular lo que tu cuerpo necesita de verdad.',
      },
      {
        eyebrow: 'Cofira · Entrenamiento',
        titulo: 'Un plan que se adapta',
        tituloAcento: 'a tu ritmo.',
        texto: 'Tu nivel, tus días y tu equipo — la rutina se construye alrededor de tu vida.',
      },
      {
        eyebrow: 'Cofira · Nutrición',
        titulo: 'Comer bien no es contar,',
        tituloAcento: 'es saber.',
        texto: 'Tu dieta, tus horarios y tus alergias definen un menú hecho para ti.',
      },
    ],
    bienvenida: {
      marcaSub: 'Sistema',
    ...
    deportes: {
      titulo: 'Que deportes puedes practicar?',
      subtitulo: 'Alternaremos tu plan de gimnasio con sesiones de estos deportes (opcional)',
      opciones: [
        { id: 'correr', label: 'Correr' },
        { id: 'ciclismo', label: 'Bicicleta / ciclismo' },
        { id: 'natacion', label: 'Natacion' },
        { id: 'futbol', label: 'Futbol' },
        { id: 'baloncesto', label: 'Baloncesto' },
        { id: 'tenis-padel', label: 'Tenis / padel' },
    ...
    registro: {
      ...
      requisitoMayuscula: '1 mayúscula',
      requisitoMinuscula: '1 minúscula',
      requisitoNumero: '1 número',
      requisitoEspecial: '1 carácter especial (!@#$...)',
      fuerzaEtiqueta: 'Seguridad',
      fuerzaDebil: 'Débil',
      fuerzaMedia: 'Media',
      fuerzaFuerte: 'Fuerte',
  ...
  en: {
    ...
    asideEscenas: [
      {
        eyebrow: 'Cofira · System',
        titulo: "You're one step from",
        tituloAcento: 'your system.',
        texto: 'Training, nutrition and progress — tailored to you.',
      },
      {
        eyebrow: 'Cofira · Your body',
        titulo: 'Your starting point',
        tituloAcento: 'is yours to set.',
        texto: 'Weight, height and goal: the base to compute what your body truly needs.',
      },
      {
        eyebrow: 'Cofira · Training',
        titulo: 'A plan that adapts',
        tituloAcento: 'to your pace.',
        texto: 'Your level, your days and your gear — the routine is built around your life.',
      },
      {
        eyebrow: 'Cofira · Nutrition',
        titulo: "Eating well isn't counting,",
        tituloAcento: "it's knowing.",
        texto: 'Your diet, schedule and allergies shape a menu made for you.',
      },
    ],
    bienvenida: {
      marcaSub: 'System',
    ...
    deportes: {
      titulo: 'What sports can you do?',
      subtitulo: 'We will alternate your gym plan with sessions of these sports (optional)',
      opciones: [
        { id: 'correr', label: 'Running' },
        { id: 'ciclismo', label: 'Cycling' },
        { id: 'natacion', label: 'Swimming' },
        { id: 'futbol', label: 'Football' },
        { id: 'baloncesto', label: 'Basketball' },
        { id: 'tenis-padel', label: 'Tennis / padel' },
        { id: 'senderismo', label: 'Hiking' },
        { id: 'yoga-pilates', label: 'Yoga / pilates' },
        { id: 'boxeo', label: 'Boxing' },
        { id: 'remo', label: 'Rowing' },
        { id: 'escalada', label: 'Climbing' },
        { id: 'patinaje', label: 'Skating' },
      ],
      botonOmitir: 'Gym only',
      botonContinuar: 'Continue',
      sufijoSeleccionados: 'selected',
    },
    resultados: {
