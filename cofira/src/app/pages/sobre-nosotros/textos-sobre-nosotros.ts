...
export const TEXTOS_SOBRE_NOSOTROS: Record<CodigoIdioma, TextosSobreNosotros> = {
  es: {
    ...
    historiaParrafo1:
      'Cofira nació en 2023 de una idea simple: hacer el fitness accesible y personalizado para todos. Creado por Alejandro Bravo, desarrollador full-stack, el proyecto nació con una visión clara: ayudar a las personas a alcanzar sus objetivos de fitness.',
    historiaParrafo2:
  ...
  en: {
    ...
    historiaParrafo1:
      'Cofira was born in 2023 from a simple idea: making fitness accessible and personal for everyone. Created by Alejandro Bravo, a full-stack developer, the project started with one clear vision: helping people reach their fitness goals.',
    historiaParrafo2:
