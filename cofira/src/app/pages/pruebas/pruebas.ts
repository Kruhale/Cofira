...
export class Pruebas {
  ...
  optimizaciones = [
    {archivo: 'arrow-left_opt.svg', original: '157 bytes', optimizado: '149 bytes', reduccion: '5%'},
    {archivo: 'check.svg', original: '202 bytes', optimizado: '197 bytes', reduccion: '2%'},
    {archivo: 'check-circle_opt.svg', original: '234 bytes', optimizado: '226 bytes', reduccion: '3%'},
    ...
    {archivo: 'exclamation-circle.svg', original: '255 bytes', optimizado: '246 bytes', reduccion: '4%'},
    {archivo: 'exclamation-triangle.svg', original: '359 bytes', optimizado: '335 bytes', reduccion: '7%'},
    ...
    {archivo: 'shield-check.svg', original: '389 bytes', optimizado: '387 bytes', reduccion: '1%'},
    ...
    {archivo: 'x-circle-solid.svg', original: '358 bytes', optimizado: '350 bytes', reduccion: '2%'},
  ];
}
