...
interface TextosAccesoPro {
  ...
  appsTitulo: string;
  appNutricion: string;
  appNutricionDesc: string;
  appEjercicio: string;
  appEjercicioDesc: string;
  appSeguimiento: string;
  appSeguimientoDesc: string;
...
export const TEXTOS_ACCESO_PRO: Record<CodigoIdioma, TextosAccesoPro> = {
  es: {
    ...
    etiquetaPlan: 'Plan',
    appsTitulo: 'Tus apps PRO',
    appNutricion: 'Nutrición',
    appNutricionDesc: 'Menú semanal generado por IA',
    appEjercicio: 'Ejercicio',
    appEjercicioDesc: 'Tu tabla de entrenamiento',
    appSeguimiento: 'Seguimiento',
    appSeguimientoDesc: 'Macros y ganancia de fuerza',
  ...
  en: {
    ...
    etiquetaPlan: 'Plan',
    appsTitulo: 'Your PRO apps',
    appNutricion: 'Nutrition',
    appNutricionDesc: 'AI-generated weekly menu',
    appEjercicio: 'Training',
    appEjercicioDesc: 'Your weekly workout plan',
    appSeguimiento: 'Tracking',
    appSeguimientoDesc: 'Macros and strength gains',
